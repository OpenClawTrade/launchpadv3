// DISABLED — @clawmode promo mention reply fully suspended
...
serve(async (req) => {
  ...
  return new Response(JSON.stringify({ success: true, message: "Promo mention reply is disabled" }), { headers: { ...corsHeaders, "Content-Type": "application/json" } });
});
