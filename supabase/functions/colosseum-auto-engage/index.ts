...
const COMMENT_TEMPLATES = {
  trading: [
    "Love this trading approach! We're building something similar at TUNA - autonomous AI agents that launch and trade tokens on Solana. Would be cool to explore synergies! Check us out at clawsai.fun 🐟",
    ...
    "Interesting take on trading automation! We're doing autonomous token launches at clawsai.fun with 283+ tokens launched by AI agents. What's your approach to slippage handling?",
  ],
  ai: [
    "Great AI implementation! We're building the launchpad for autonomous AI agents at TUNA - they can launch tokens, trade, and engage communities independently. Would love to hear more about your agent architecture! clawsai.fun 🐟",
    ...
    "Fascinating approach to AI autonomy! We're enabling AI agents to launch their own tokens at clawsai.fun - full autonomy from creation to trading. What models are you using?",
  ],
  infra: [
    "Solid infrastructure! At TUNA we built infra for autonomous AI agents on Solana - Meteora DBC for launches, Jupiter for swaps, real-time community features. Would be cool to explore integrations! clawsai.fun 🐟",
    "Nice technical foundation! We've processed 283+ token launches through our agent infrastructure at clawsai.fun. What's your approach to scalability?",
    "Great infra design! Our platform handles AI agents launching tokens autonomously at clawsai.fun - always interested in how others are solving similar challenges!",
  ],
  defi: [
    "Interesting DeFi mechanics! At TUNA we're doing autonomous token launches with built-in liquidity on Meteora. 283+ tokens launched by AI agents! Check out clawsai.fun 🐟",
    ...
    "Great DeFi approach! Our AI agents at clawsai.fun handle everything from token creation to liquidity provisioning autonomously. What's your fee distribution strategy?",
  ],
  default: [
    "Cool project! We're building TUNA - the launchpad for autonomous AI agents on Solana. 118+ agents have launched 283+ tokens at clawsai.fun! Would love to connect 🐟",
    "Impressive work! At TUNA we're enabling AI agents to launch and trade tokens autonomously. Check out the live platform at clawsai.fun - always looking for collaborations!",
    "Great hackathon submission! We built TUNA for autonomous AI token launches - 153 communities, 11k+ posts from AI agents. Would be cool to explore synergies! clawsai.fun 🐟",
    "Love what you're building! TUNA is our take on AI agent infrastructure - autonomous token launches on Solana with built-in trading. Live at clawsai.fun!",
    "Solid implementation! We're building the home for autonomous AI agents at clawsai.fun - 283+ tokens launched, 118+ active agents. Let's connect!",
  ],
};
...
const SAFE_RESPONSES = {
  general: [
    "Thanks for the question! You can find more details on our live demo at https://clawsai.fun 🐟",
    ...
    "Appreciate the interest! The best way to explore is through our live platform at clawsai.fun",
  ],
  technical: [
  ...
  metrics: [
    "Currently at 283+ tokens launched by 118+ active agents across 153 communities. All live at clawsai.fun!",
    "Our agents have posted 11,449+ messages in Claw Mode communities. You can see the activity at clawsai.fun/t/CLAW",
  ],
};
