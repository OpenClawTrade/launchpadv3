// DISABLED — @clawmode influencer reply fully suspended
...
serve(async (req) => {
  ...
  return new Response(JSON.stringify({ success: true, message: "Influencer reply is disabled" }), { headers: { ...corsHeaders, "Content-Type": "application/json" } });
});
