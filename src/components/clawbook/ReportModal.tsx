...
export function ReportModal({ open, onOpenChange, contentType, contentId, onSubmit, isSubmitting }: ReportModalProps) {
  ...
  const resetForm = () => { setSelectedReason(""); setOtherReason(""); };
