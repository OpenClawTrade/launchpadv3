                      ...
                      <>
                        ...
                        {!isPhantomGenerating && (phantomSubMode === "custom" || phantomMeme || phantomToken.name) && (
                          <>
                            <TokenLaunchForm
                              token={phantomToken}
                              setToken={setPhantomToken}
                              imagePreview={phantomImagePreview}
                              memeImageUrl={phantomMeme?.imageUrl}
                              onImageChange={handlePhantomImageChange}
                              onClearImage={() => { setPhantomImageFile(null); setPhantomImagePreview(null); if (phantomMeme) setPhantomMeme({ ...phantomMeme, imageUrl: "" }); setPhantomToken({ ...phantomToken, imageUrl: "" }); }}
                            />
                  ...
                  <>
                    <TokenLaunchForm
                      ...
                      onClearImage={() => {
                        setPhantomImageFile(null);
                        setPhantomImagePreview(null);
                        if (phantomMeme) setPhantomMeme({ ...phantomMeme, imageUrl: "" });
