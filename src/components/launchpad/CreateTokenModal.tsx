  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 md:px-10 pt-3 md:pt-8 pb-3 md:pb-2">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <p className="text-xs md:text-xs text-[#64748B] font-medium mt-0.5">via X (Twitter)</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Content — scrollable */}
        <div className="flex-1 overflow-y-auto px-5 md:px-10 py-4 md:py-6 space-y-6 md:space-y-6">
          {/* Intro */}
          <p className="text-[15px] md:text-[15px] text-[#CBD5E1] leading-[1.6]">
          ...
          <div className="space-y-0">
            ...
            <div className="flex items-start gap-4 md:gap-4">
              ...
              <div className="flex-1 pt-1">
                <p className="text-[15px] md:text-[14px] font-medium text-[#E2E8F0] leading-snug">
            ...
            <div className="flex items-start gap-4 md:gap-4">
              <StepNumber n={2} />
              <p className="text-[15px] md:text-[14px] text-[#CBD5E1] pt-1 leading-[1.55]">
