...
const steps = [
  ...
  },
  {
    ...
    bg: 'bg-yellow-400/10',
    description: 'Trades execute using x·y=k bonding curve denominated in satoshis. Virtual reserves (0.3 BTC + 1.073B tokens) provide initial liquidity. 800M tokens available for purchase. 1% platform fee deducted BEFORE entering the pool.',
