...
export function NoCommunityFound({ ticker }: NoCommunityFoundProps) {
  ...
  return (
    <div className="tunabook-card p-8 text-center">
      <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[hsl(var(--tunabook-bg-elevated))] flex items-center justify-center">
        <Robot size={32} className="text-[hsl(var(--tunabook-text-muted))]" />
      </div>
      ...
      <p className="text-[hsl(var(--tunabook-text-secondary))] mb-6 max-w-md mx-auto">
        {token 
          ? `$${ticker?.toUpperCase()} doesn't have an AI-powered community. This token was launched without an AI agent.`
          : `t/${ticker} doesn't exist. This community hasn't been created yet.`
        }
      </p>
