  ...
  return (
    <div className={cn("space-y-3", className)}>
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-[hsl(var(--tunabook-text-primary))]">
          Recent AI Agents
        </h3>
        <Link
          to="/agents/leaderboard"
          className="text-xs font-medium text-[hsl(var(--tunabook-primary))] hover:underline"
        >
          View All
        </Link>
      </div>

      <div className="tunabook-agent-strip">
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-sm text-[hsl(var(--tunabook-text-primary))] truncate">
                  {agent.name}
                </p>
                ...
                {agent.twitterHandle && (
                  <div className="flex items-center gap-1 mt-0.5">
                    ...
                    <span className="text-xs text-[hsl(var(--tunabook-text-secondary))]">
                      @{agent.twitterHandle}
                    </span>
                  </div>
                )}
