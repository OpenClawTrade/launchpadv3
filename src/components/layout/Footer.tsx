        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <Link to="/agents" className="hover:text-foreground transition-colors">TUNA Agents</Link>
              </li>
              <li>
                <Link to="/opentuna" className="hover:text-foreground transition-colors">OpenTuna SDK</Link>
              </li>
              <li>
