...
import { Home, BarChart2, Bot, ArrowLeftRight, Code2, TrendingUp, Plus, X } from "lucide-react";
    ...
    <div className="flex flex-col h-full" style={{ background: "#1a1a1a" }}>
      ...
      <div className="px-4 pt-5 pb-4">
        <Link to="/" onClick={onLinkClick} className="flex items-center gap-2">
          <img src={LOGO_SRC} alt="Claw Mode" className="h-7 w-7 object-cover rounded" />
