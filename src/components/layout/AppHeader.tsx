  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        >
          <div className="h-4 w-4" style={{ WebkitMaskImage: `url(${clawLogo})`, maskImage: `url(${clawLogo})`, WebkitMaskSize: 'contain', maskSize: 'contain', WebkitMaskRepeat: 'no-repeat', maskRepeat: 'no-repeat', WebkitMaskPosition: 'center', maskPosition: 'center', backgroundColor: '#4ade80' }} />
          Panel
        </button>
