      ...
      <div className="text-center mb-8">
        ...
        <div className="flex flex-wrap justify-center gap-2 text-xs">
          <div className="claw-badge">
            <span className="font-medium" style={{ color: "hsl(var(--claw-text))" }}>AI Scoring</span> — 0-100 token analysis
          </div>
          <div className="claw-badge">
            <span className="font-medium" style={{ color: "hsl(var(--claw-text))" }}>Jupiter DEX</span> — Execution layer
          </div>
          <div className="claw-badge">
            <span className="font-medium" style={{ color: "hsl(var(--claw-text))" }}>Internal SL/TP</span> — Risk management
          </div>
        </div>
      </div>
