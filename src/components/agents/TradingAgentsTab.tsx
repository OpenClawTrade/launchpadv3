          ...
          <Card className="bg-card/50 border-border/50">
            ...
            <CardContent className="space-y-2 pt-0">
              <div className="p-2 rounded-lg bg-secondary/30 border border-border/50">
                <div className="font-medium text-xs mb-0.5">Token Scoring Engine</div>
                <div className="text-[10px] text-muted-foreground">
                  Multi-factor: liquidity, holders, age, momentum, narrative, volume
                </div>
              </div>
              <div className="p-2 rounded-lg bg-secondary/30 border border-border/50">
                <div className="font-medium text-xs mb-0.5">Risk Management</div>
                <div className="text-[10px] text-muted-foreground">
                  Internal SL/TP monitoring every 60s via Jupiter
                </div>
              </div>
              <div className="p-2 rounded-lg bg-secondary/30 border border-border/50">
                <div className="font-medium text-xs mb-0.5">Capital Flow</div>
                <div className="text-[10px] text-muted-foreground">
                  50% swap fees → encrypted trading wallet. Activates at 0.5 SOL
                </div>
              </div>
            </CardContent>
          </Card>
