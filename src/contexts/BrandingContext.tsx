...
const DEFAULT_CONFIG: BrandingConfig = {
  ...
  discordUrl: null,
  telegramUrl: null,
  logoUrl: "/popshiba-logo.png",
  faviconUrl: "/favicon.png",
  ogImageUrl: "https://popshiba.com/og-image.png",
  ...
  pageTitle: "Saturn Trading Terminal - BNB Chain",
  metaDescription: "Saturn — Your one step trading Terminal and Launchpad on BNB Chain.",
};
